...
public class School {
     ...
     */
    public void getMonthlyMenu(TextView school_food_title,TextView school_food_text,int year, int month) throws SchoolException {
        ...
        try {
            (new GetSchoolInfo(school_food_title,school_food_text,"getMonthlyMenu",new URL(targetUrl.toString()), "<tbody>", "</tbody>")).execute();
     ...
     */
    public void getMonthlySchedule(TextView school_schedule_title,TextView school_schedule_text,int year, int month) throws SchoolException {
        ...
        try {
            (new GetSchoolInfo(school_schedule_title,school_schedule_text,"getMonthlySchedule",new URL(targetUrl.toString()), "<tbody>", "</tbody>")).execute();
